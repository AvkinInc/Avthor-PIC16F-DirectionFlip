...
void Step(direction dir, uint16_t num_steps1, step_size size1, uint16_t num_steps2, step_size size2, _Bool haptic_breaths){
...
# 45 "step/step.c"
    for(uint16_t i = 0; i < (num_steps1); i++){
...
# 65 "step/step.c"
    ...
    for(uint16_t i = 0; i < (num_steps2); i++){
        if(get_INTERRUPT_BREAK_FLAG()){
            break;
        }else{
            do { LATCbits.LATC1 = 1; } while(0);
...
void inchUp(void){
    Step(UP, (200*2*4), Quarter, 0, NullStep, 0);
}

void inchDown(void){
    Step(DOWN, (200*2*4), Quarter, 0, NullStep, 0);
}
...
void topButtonTrigger(void){
    ...
    Step(DOWN, (200*rotations*4), Quarter, 0, NullStep, 0);
    set_INTERRUPT_BREAK_FLAG(1);
}
...
void bottomButtonTrigger(void){
    ...
    Step(UP, (200*rotations*4), Quarter, 0, NullStep, 0);
    set_INTERRUPT_BREAK_FLAG(1);
}
