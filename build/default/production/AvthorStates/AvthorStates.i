...
# 2 "<built-in>" 2
# 1 "AvthorStates/AvthorStates.c" 2
...
# 6 "AvthorStates/AvthorStates.h" 2
...
# 7 "AvthorStates/AvthorStates.h" 2
...
# 2 "AvthorStates/AvthorStates.c" 2
# 12 "AvthorStates/AvthorStates.c"
...
void initAvthorStates(void){
    ...
    Avthor_States.INTERRUPT_BREAK_FLAG = 0;
    Avthor_States.motor_action = none;
    for (int i = 0; i < 5; i++){
        Avthor_States.complex_breaths_instructions[i] = 0;
    }
    Avthor_States.complex_breaths_instruction_pointer = &Avthor_States.complex_breaths_instructions[0];
    Avthor_States.IS_RECEIVING_COMPLEX_BREATHS_COMMANDS = 0;
    Avthor_States.bellowsHasBeenInchedUpOrDownSinceVenting = 1;
}
...
# 98 "AvthorStates/AvthorStates.c"
void Avthor_Uart_Instruction(uint8_t instr){
    ...
    if(instr == 'z'){
        ...
        Avthor_States.stepper_instruction = 0x00;
        Avthor_States.INTERRUPT_BREAK_FLAG = 1;
        Avthor_States.motor_action = none;
        Avthor_States.IS_RECEIVING_COMPLEX_BREATHS_COMMANDS = 0;
        stepperSleep(1);
        EUSART_Write(0xFB);
  ...
  Avthor_States.INTERRUPT_BREAK_FLAG = 1;
    ...
    if((Avthor_States.IS_RECEIVING_COMPLEX_BREATHS_COMMANDS) && (instr != 0xA9)){
        *Avthor_States.complex_breaths_instruction_pointer = instr;

        Avthor_States.complex_breaths_instruction_pointer++;
        ...
        switch(instr){
            case 0xA9: {
                ...
                if(!Avthor_States.IS_RECEIVING_COMPLEX_BREATHS_COMMANDS){
                    Avthor_States.IS_RECEIVING_COMPLEX_BREATHS_COMMANDS = 1;
                    Avthor_States.complex_breaths_instruction_pointer = &Avthor_States.complex_breaths_instructions[0];
                }else{
                    Avthor_States.IS_RECEIVING_COMPLEX_BREATHS_COMMANDS = 0;
                ...
                Avthor_States.bellowsHasBeenInchedUpOrDownSinceVenting = 0;
