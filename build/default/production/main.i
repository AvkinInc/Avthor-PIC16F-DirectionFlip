...
# 60 "././step/step.h"
void Step(direction dir, uint16_t numSteps1, step_size size1, uint16_t numSteps2, step_size size2, _Bool haptic_breaths);
void calibrate(void);
...
void stepperSleep(_Bool in);
void setStepSize(step_size size);
void setDirection(direction dir);
void sendHapticCommand(uint8_t input);
# 45 "main.c" 2

# 1 "././AvthorStates/AvthorStates.h" 1
# 33 "././AvthorStates/AvthorStates.h"
typedef enum {
    none = 0x1,
    complexBreaths = 0x2,
    calibrating = 0x3,
...
typedef volatile struct{
    uint8_t stepper_instruction;
    _Bool INTERRUPT_BREAK_FLAG;
    motorAction motor_action;
    char complex_breaths_instructions[5];
    char *complex_breaths_instruction_pointer;
    _Bool IS_RECEIVING_COMPLEX_BREATHS_COMMANDS;
    _Bool bellowsHasBeenInchedUpOrDownSinceVenting;
}avthorStates;
...
_Bool get_INTERRUPT_BREAK_FLAG(void);
uint8_t get_complex_breaths_instructions_index(uint8_t index);
_Bool get_IS_RECEIVING_COMPLEX_BREATHS_COMMANDS(void);
_Bool get_bellowsHasBeenInchedUpOrDownSinceVenting(void);
void set_stepper_instruction(uint8_t in);
void set_INTERRUPT_BREAK_FLAG(_Bool in);
void set_IS_RECEIVING_COMPLEX_BREATHS_COMMANDS(_Bool in);
            ...
            case complexBreaths: {
                ...
                switch(get_complex_breaths_instructions_index(1)){
                    ...
                    case '0': {
                        ...
                        steps_multiplier_1 = 16;
                        break;
                    }case 1:
                    case '1': {
                        step_size_in_1 = Full;
                        steps_multiplier_1 = 1;
                        break;
                    }case 2:
                    case '2': {
                        step_size_in_1 = Half;
                        steps_multiplier_1 = 2;
                        break;
                    }case 4:
                    case '4': {
                        step_size_in_1 = Quarter;
                        steps_multiplier_1 = 4;
                        break;
                    }case 8:
                    case '8': {
                        step_size_in_1 = Eighth;
                        steps_multiplier_1 = 8;
                        break;
                    }case 16: {
                ...
                switch(get_complex_breaths_instructions_index(3)){
                    ...
                    case '0': {
                        ...
                        steps_multiplier_2 = 16;
                        break;
                    }case 1:
                    case '1': {
                        step_size_in_2 = Full;
                        steps_multiplier_2 = 1;
                        break;
                    }case 2:
                    case '2': {
                        step_size_in_2 = Half;
                        steps_multiplier_2 = 2;
                        break;
                    }case 4:
                    case '4': {
                        step_size_in_2 = Quarter;
                        steps_multiplier_2 = 4;
                        break;
                    }case 8:
                    case '8': {
                        step_size_in_2 = Eighth;
                        steps_multiplier_2 = 8;
                        break;
                    }case 16: {
                ...
                Step(UP, numSteps1, step_size_in_1, numSteps2, step_size_in_2, 1);


                _delay((unsigned long)((15)*(4000000/4000.0)));
                Step(DOWN, numSteps2, step_size_in_2, numSteps1, step_size_in_1, 1);


                _delay((unsigned long)((5)*(4000000/4000.0)));

                if((breath_counter_for_smallVent++ == 10) && get_bellowsHasBeenInchedUpOrDownSinceVenting() == 0){
 ...
 switch(charIn){
  ...
  case 's': {
   ...
   break;
    ...
    Step(UP, (numRotations*stepMultiplier1*200/2), stepSize1, (numRotations*stepMultiplier2*200/2), stepSize2, 1);


    _delay((unsigned long)((10)*(4000000/4000.0)));
    Step(DOWN, (numRotations*stepMultiplier2*200/2), stepSize2, (numRotations*stepMultiplier1*200/2), stepSize1, 1);
...
void eighthsTest(char charIn){
 ...
 _delay((unsigned long)((10)*(4000000/4000.0)));
    ...
    Step(UP, (numRotations*stepMultiplier1*ratio1), stepSize1, (numRotations*stepMultiplier2*ratio2), stepSize2, 1);


 _delay((unsigned long)((10)*(4000000/4000.0)));
    Step(DOWN, (numRotations*stepMultiplier2*ratio2), stepSize2, (numRotations*stepMultiplier1*ratio1), stepSize1, 1);
